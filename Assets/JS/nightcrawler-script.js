...
// Gets character name and pic from Marvel API then applies to page
async function getCharData(charName) {
    try {
        ...
        picEl.attr({src: picUrl, alt:"Nightcrawler with his glowing yellow eyes brandishes a sword towards the viewer" })
